...
function getNodes(definitionNodes, options) {
    ...
    const nodes = definitionNodes.objectTypes.map((definition) => {
        ...
        const idField = (_a = definition.fields) === null || _a === void 0 ? void 0 : _a.find((x) => x.name.value === "id");
        if (globalIdField && idField) {
            const hasAlias = (_b = idField.directives) === null || _b === void 0 ? void 0 : _b.find((x) => x.name.value === "alias");
            if (!hasAlias) {
        ...
        const node = new classes_1.Node({
            ...
            description: (_c = definition.description) === null || _c === void 0 ? void 0 : _c.value,
            globalIdField: globalIdField === null || globalIdField === void 0 ? void 0 : globalIdField.fieldName,
