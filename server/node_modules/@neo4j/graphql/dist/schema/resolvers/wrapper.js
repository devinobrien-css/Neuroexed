...
const wrapResolver = ({ driver, config, nodes, relationships, schema, plugins }) => (next) => async (root, args, context, info) => {
    ...
    if (!(context === null || context === void 0 ? void 0 : context.executionContext)) {
...
const wrapSubscription = (resolverArgs) => (next) => async (root, args, context, info) => {
    const plugins = (resolverArgs === null || resolverArgs === void 0 ? void 0 : resolverArgs.plugins) || {};
    const contextParams = (context === null || context === void 0 ? void 0 : context.connectionParams) || {};
    ...
    if (!(context === null || context === void 0 ? void 0 : context.jwt) && contextParams.authorization) {
