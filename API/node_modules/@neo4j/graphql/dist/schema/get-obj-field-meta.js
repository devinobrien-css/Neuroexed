        ...
        if (relationshipMeta) {
            ...
            if (["DateTime", "Date", "Time", "LocalDateTime", "LocalTime"].includes(typeMeta.name)) {
                ...
                if (idDirective) {
                    ...
                    const global = (_x = idDirective.arguments) === null || _x === void 0 ? void 0 : _x.find((a) => a.name.value === "global");
                    if (global) {
                        primitiveField.isGlobalIdField = true;
                    }
                }
                if (defaultDirective) {
                    const value = (_z = (_y = defaultDirective.arguments) === null || _y === void 0 ? void 0 : _y.find((a) => a.name.value === "value")) === null || _z === void 0 ? void 0 : _z.value;
                ...
                if (coalesceDirective) {
                    const value = (_1 = (_0 = coalesceDirective.arguments) === null || _0 === void 0 ? void 0 : _0.find((a) => a.name.value === "value")) === null || _1 === void 0 ? void 0 : _1.value;
                    const checkKind = (kind) => {
                        if ((value === null || value === void 0 ? void 0 : value.kind) !== kind) {
