...
function translateRead({ node, context, isRootConnectionField, }) {
    ...
    const interfaceStrs = [];
    const returnStrs = [];
    const hasLimit = Boolean(optionsInput === null || optionsInput === void 0 ? void 0 : optionsInput.limit) || (optionsInput === null || optionsInput === void 0 ? void 0 : optionsInput.limit) === 0;
    ...
    if (isRootConnectionField) {
        ...
        const sortCypherFields = (_h = (_g = projection[2]) === null || _g === void 0 ? void 0 : _g.rootConnectionCypherSortFields) !== null && _h !== void 0 ? _h : [];
